...
def load_topics(data_samples):
    ...
    tfidf_vectorizer = TfidfVectorizer(max_df=0.95, min_df=1,ngram_range=(3,3),token_pattern=r'\b\w+\b',
    ...
    tf_vectorizer = CountVectorizer(max_df=0.95, min_df=1,ngram_range=(3,3),token_pattern=r'\b\w+\b',
